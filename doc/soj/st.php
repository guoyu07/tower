...
$log[PAGE_NAME] = (string)$_GET["pn"];
$log[GUID_KEY] = (string)$_GET["guid"];
$log[UGUID_KEY] = $sguid;
$log[URL_KEY] = (string)$_GET["h"];
$log[REFERER_KEY] = (string)$_GET["r"];
$log[SITE_KEY] = (string)$_GET["site"];
$log[STAMP_KEY] = (string)$sec . sprintf('%03d', (int)($usec * 1000));
$log[CLIENT_IP_KEY] = (string)get_client_ip();
$log[SESSION_ID_KEY] = (string)$_GET["ssid"];
$log[LOAD_TIME_KEY] = (string)$_GET["lt"];

$log[USER_ID_KEY] = (string)$_GET["uid"];
$log[CITY_ID_KEY] = (string)$_GET["ctid"];
$log[LAST_USER_INFO_KEY] = (string)$_GET["luid"];
$log[CLIENT_STAMP_KEY] = (string)$_GET["t"];
$log[CUSTOM_PARAM] = (string)$_GET["cp"];

$screen = json_decode($_GET["sc"], TRUE);

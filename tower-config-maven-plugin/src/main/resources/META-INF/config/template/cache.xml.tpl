...
<properties>
	...
	<!--缓存总开关-->
	<entry key="#{artifactId}.query.cacheable">false</entry>
	<!--主键缓存开关-->
	<entry key="#{artifactId}.query.cacheable.pk">false</entry>
	<!--外键缓存开关-->
	<entry key="#{artifactId}.query.cacheable.fk">false</entry>
	<!--表级缓存开关-->
	<entry key="#{artifactId}.query.cacheable.tb">false</entry>

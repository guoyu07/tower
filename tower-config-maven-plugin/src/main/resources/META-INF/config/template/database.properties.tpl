...
cache_db_slave.password = #{company}@)!$
...
cache_db_map_query.password = #{company}@)!$
...
#{artifactId}_db.password = #{company}@)!$
...
#{artifactId}_db_slave.password = #{company}@)!$
...
#{artifactId}_db_map_query.password = #{company}@)!$
